...
export class StavkaPorudzbineComponent implements OnInit, OnDestroy, OnChanges {
  ...
  displayedColumns = ['id', 'redniBroj', 'kolicina', 'jedinicaMere', 'cena',
   'porudzbina', 'artikl', 'actions'];
  ...
  loadData() {
    this.subcription = this.stavkaPorudzbineService.getStavkeZaPorudzbinaID(this.selektovanaPorudzbina.id)
          .subscribe(data => {
